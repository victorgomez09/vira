"""
Virapi - A simple ASGI framework for educational purposes.
"""
...
class Virapi:
    """Main Virapi application class. To create an application, instantiate this class."""
    ...
    def __init__(
        ...
        """Initialize the Virapi application.
    ...
    def add_plugin(self, plugin_cls: Type[ViraPlugin], **kwargs):
        """
        Registers and initializes a plugin in the virapi application.
