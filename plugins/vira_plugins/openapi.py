...
try:
    # If Pydantic is installed (the user used vira[validation]), the real ones are imported.
    from pydantic import BaseModel as BASE_MODEL
    ...
    print("Vira: Pydantic not detected. OpenAPI Request Body generation is disabled.")
# ---------------------------------------------------------------------------

# Note: I assume that the ViraPlugin, Response, and Vira classes are defined in other files
...
class OpenAPIDocs:
    """
    Class to generate the OpenAPI schema from Vira routes,
    ...
    def _generate_paths(self) -> Dict[str, Any]:
        ...
        for route in routes_list:
            ...
            # Assuming Vira's format is {name:type}
            openapi_path = re.sub(
