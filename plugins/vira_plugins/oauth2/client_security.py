...
async def handle_callback_and_create_session(request: Any) -> Response:
    ...
    try:
        # Synchronous request, consider using 'httpx' if Vira needs to be 100% asynchronous.
...
def get_current_oauth_user(request: Any) -> User:
    ...
    # Assume that request.cookies is a dict (attached by Vira)
