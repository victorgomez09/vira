...
if TYPE_CHECKING:
    from virapi import virapi # Ensure typing only at type-check time

class ViraJWTAuthPlugin(ViraPlugin):
    """
    Plugin for virapi that implements JWT authentication with PyJWT.
    """
    def __init__(
        self, 
        app: 'virapi', 
    ...
    def register(self):
        ...
        # 2. Optional: Attach the decorators to the virapi app object for easy access
